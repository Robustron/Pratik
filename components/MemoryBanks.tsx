...
const skills = [
  ...
  { label: 'Supabase', category: 'Engineering' },
  { label: 'PostgreSQL', category: 'Engineering' },
  { label: 'Prisma', category: 'Engineering' },
  { label: 'Redis', category: 'Engineering' },
  { label: 'Docker', category: 'Engineering' },
  { label: 'AWS', category: 'Engineering' },
  { label: 'Firebase', category: 'Engineering' },
  { label: 'Vercel Serverless', category: 'Engineering' },
  { label: 'ERC-1155 Token Architecture', category: 'Web3/Infra' },
  { label: 'Blockchain Asset Projection', category: 'Web3/Infra' },
  { label: 'Geospatial GIS (Leaflet, GeoJSON)', category: 'Web3/Infra' },
  { label: 'RBAC', category: 'Web3/Infra' },
  { label: 'Security Hardening', category: 'Web3/Infra' },
  { label: 'UI/UX Design', category: 'Product & UX' },
  { label: 'Rapid Prototyping', category: 'Product & UX' },
  ...
  { label: 'Remote Sensing APIs', category: 'Data' },
  { label: 'Qualitative Research', category: 'Data' },
